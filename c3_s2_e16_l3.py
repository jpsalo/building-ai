...
def main(X_train, X_test, y_train, y_test):
    ...
    for i, test_item in enumerate(X_test):
        ...
        label_classes = []
        for j, k_nearest_index in enumerate(k_nearest):
            label_classes.append(y_train[k_nearest_index])

        y_predict_mean = np.round(np.mean(label_classes))
